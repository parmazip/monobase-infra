# Monobase Patient Helm Chart

Helm chart for deploying the Monobase Patient frontend application.

## Overview

The Monobase Patient chart deploys the frontend web application that users interact with.
...
patient:
  ...
  replicaCount: 2
  image:
    repository: ghcr.io/monobaselabs/patientapp
    tag: "1.0.0"
```
...
- **Type:** boolean
- **Default:** `true`
- **Description:** Enable or disable Patient frontend deployment

### patient.replicaCount
- **Type:** integer
- **Default:** `2`
- **Staging:** `1`
- **Production:** `2-3`
...
- **Type:** string
- **Default:** `ghcr.io/monobaselabs/patientapp`
...
### patient.gateway.hostname
- **Type:** string
- **Default:** Empty (uses `patient.{global.domain}`)
- **Example:** `patient.myclient.com` or `portal.custom-domain.com`
- **Description:** Custom hostname for frontend. If empty, defaults to patient.{global.domain}

## High Availability

### patient.podDisruptionBudget.enabled
- **Type:** boolean
- **Default:** `true`
- **Production:** `true` (recommended for HA)

### patient.podDisruptionBudget.minAvailable
- **Type:** integer
- **Default:** `1`
...
3. **Access:** Frontend will be available at `patient.{global.domain}`
